...
public class Sale {
	 ...
	 * @throws ItemNotFoundException        if item is not found in inventory.
	 * @throws UnreachableDatabaseException if database crashes
	 */
	public void registerItem(int itemID) throws UnreachableDatabaseException, ItemNotFoundException {
