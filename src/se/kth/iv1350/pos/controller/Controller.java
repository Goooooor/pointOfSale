...
public class Controller {
	 ...
	 * @throws ItemNotFoundException    if item can not be found with
	 *                                  itemID.
	 */
	public ItemDTO registerItem(int itemID) throws OperationFailedException, ItemNotFoundException {
		try {
